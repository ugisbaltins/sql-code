...
describe("Foreign Keys", () => {
  ...
  it(
    ...
    async done => {
      const directorId = 7;
      const query = `DELETE FROM GENRES WHERE id = ` + directorId;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const actorId = 10;
      const query = `DELETE FROM GENRES WHERE id = ` + actorId;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const keywordId = 12;
      const query = `DELETE FROM GENRES WHERE id = ` + keywordId;
      try {
        await db.delete(query);
      } catch (e) {}
  ...
  it(
    ...
    async done => {
      const companyId = 12;
      const query = `DELETE FROM GENRES WHERE id = ` + companyId;
      try {
        await db.delete(query);
      } catch (e) {}
